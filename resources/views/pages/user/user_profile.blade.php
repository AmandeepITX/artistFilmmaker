                ...
                <div class="row">
                    ...
                    <div class="mb-1 col-md-6">
                        ...
                        <select class="form-select" name="seekin_filmmaker"
                            ...
                            <option value='1'
                                {{ old('seekin_filmmaker', @$user->userProfile->seekin_filmmaker) == '1' ? 'selected' : '' }}>
                                Yes
                            </option>
                            <option value='0'
                                {{ old('seekin_filmmaker', @$user->userProfile->seekin_filmmaker) == '0' ? 'selected' : '' }}>
                                No
                            </option>
                        </select>
                        ...
                        <div class="d-flex">
                            <div class=" Upload-img">
                                ...
                                <input type="file" class="real-file" id="other_id" name="image"
                                    value="{{ @$user->userProfile->image }}" hidden="hidden">

                                <a type="button" class="custom-button mt-3" onclick="openfileDialog()">UPDATE
                                    IMAGE</a><br>
