<p style="color:#3d4852;font-size: 16px;line-height:1.5em;">Hi Admin,You have New Message From <span style="text-decoration: underline;">{{@$contact->name}} </span></p>
<p style="color:#3d4852;font-size: 16px;line-height:1.5em;">Email : {{@$contact->email}}</p>
...
<p style="color:#3d4852;font-size: 16px;line-height:1.5em;"><a href="{{route('login')}}">Click to login Artist Replugged</a></p>
